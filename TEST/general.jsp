...
.seller-info-area .seller-id{
  font-size: 15px; color: #000;
}
.seller-info-area li{
  line-height: 26px; font-size: 13px; color: #666;
}
.seller-info-area .seller{
  font-size: 13px;
}
.seller-info-area strong{
  font-size: 18px; font-weight: 600; color: #000;
}
.seller-info-area .buy-satisfaction strong{
  margin-left: 20px;
}
.seller-info-area a{
...
.seller-info-area .btn-seller-favorite{
  top: 10px; right: 10px;
}
.seller-info-area .btn-seller-favorite.sel{
  top: 10px; right: 10px;
}
.seller-info-area .seller-favorite-icon{
  background-position: -75px 0; height: 21px;
}
.seller-info-area .seller-favorite-icon.sel{
  background-position: -115px -38px; height: 21px;
}
.seller-info-area .btn-store-more{
  top: 52px; right: 10px;
}
.seller-info-area .store-icon{
...
.review-pagination{
  position: relative; clear: both; padding: 13px 0 13px 0;
  border-bottom: 2px solid #cecece;
  color: #333; background-color: #f2f2f2; text-align: center;
  font-size: 14px;
  margin-bottom: 30px;
}
...
.review-pagination a {
  ...
  margin-left: -5px; padding: 6px 9px 5px 10px;
...
.review-pagination a:hover:not(.active) {background-color: #ddd;}

.review-pagination a:first-child {
...
.qna-pagination a {
  color: black; padding: 8px 16px; text-decoration: none; border: 1px solid #ddd;
  margin-left: -5px; padding: 6px 9px 5px 10px; border: 1px solid #c3c3c3;
  border-right-color: #929292; border-bottom-color: #838383;
  border-left-color: #b7b7b7; background-color: #ffff;
  box-shadow: 1px 1px 2px #d7d7d7; text-decoration-line: none; color: #000;
}
...
.qna-pagination a:hover:not(.active) {
  background-color: #ddd;
}
.qna-pagination a:first-child {
  border-top-left-radius: 5px;
  border-bottom-left-radius: 5px;
}
.qna-pagination a:last-child {
  border-top-right-radius: 5px;
  border-bottom-right-radius: 5px;
}
/* 상품문의 구현 끝 */
    ...
    <div class="product-category">
      ...
      <!-- 상단 상품 카테고리 위치 표시 끝 -->
        ...
        <h2 class="product-subname">
          KH Warranty | Quick Shipping from #1 US Seller!
        </h2>
      <!-- product-simple-area 시작 -->
        ...
        <div class="simple-layout-right">
          <div class="product-info">
              ...
              <ul class="list-info">
                ...
                <li>
                  <dl>
                    ...
                    <dd>
                      5일 2시간 34분 47초 남음 (03월 07일 11시 26분 28초)
                      <a href="javascript:void(0)" class="btn-deadline" id="btn-modal-deadline_open">
                        <i class="deadline-icon"></i>
                        마감연장
                      </a>
                      <a href="javascript:void(0)" class="btn-bidlist" id="btn-modal-bidlist_open">
            ...
            <div id="deadline-modal">
              <div class="deadline-content">
                <button type="button" id="btn-modal-deadline-close">X</button> 
                <h2>마감연장 창</h2>
                <br>
                <p>마감연장 모달 창입니다. <br>
                   추후 구현 예정입니다.</p>
          ...
          <!-- 경매기록 모달창 시작 -->
            ...
            <div class="product-info-btn-area">
              <a href="<c:url value='/testPage/insert'></c:url>" class="btn-bid" id="btn-modal-bid_open" onclick="btnBid()">입찰하기
            ...
            <div class="seller-info-area">
              ...
              <ul>
                <li class="seller-id">
                  <div class="seller" style="width: 84px; display: inline-block;">판매자</div>
              ...
              <a href="javascript:void(0)" class="btn-seller-favorite" id="btn-seller-like">
                판매자 찜
                <span class="seller-favorite-icon" id="btnSellerLike"></span>
              </a>
      ...
      <div class="product-tab-wrap">
        ...
        <div class="product-review-area" id="tab2">
          ...
          <div class="review-pagination" id="review-page">
            <a href="#">&laquo;</a>
        ...
        <div class="product-qna-area" id="tab3">
          <div class="box-qna-area">
            ...
            <div class="list-qna">
              ...
              <div class="qna-pagination" id="qna-page">
                <a href="#">&laquo;</a>
                <a href="#" class="page-link active">1</a>
                <a href="#" class="page-link">2</a>
                <a href="#" class="page-link">3</a>
...
// 판매자 찜버튼
$(function(){
  const btnSellerLike = document.getElementById("btn-seller-like");
  const btnSellerLikeSel = document.getElementById("btnSellerLike");
  
  btnSellerLike.addEventListener("click", function() {
    const hasClass = btnSellerLikeSel.classList.toggle("sel");
    if(hasClass){
      alert("판매자 찜하기를 등록했습니다.");
    }else{
