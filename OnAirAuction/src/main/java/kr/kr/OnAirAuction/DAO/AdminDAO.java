...
public interface AdminDAO {
	...
	ArrayList<RatingStandardVO> selectRatingStandard();

	void insertRatingStandard(@Param("rs")RatingStandardVO rs);

	int updateRatingStandard(@Param("rs")RatingStandardVO rs);

	boolean deleteRatingStandard(@Param("rs_ml_name")String rs_ml_name);
