            ...
            <div class="comList2">
                <ul class="list-unstyled">
                    <li class="clearFix">
                        ...
                        <c:if test="${user != null && !user.me_id.equals('admin')}">
							 <p>
                        	...
                        	<p>
                            	<a href="<c:url value='/MyPage/participateAuctionList'></c:url>" onmouseover="mouseOver1(this)" onmouseout="mouseOut1(this)">마이페이지</a>
                        	</p>
                        </c:if>
                        <c:if test="${user.me_id.equals('admin')}">
                        	<p>
                            	<a href="<c:url value='/logout'></c:url>">로그아웃</a>
                        	</p>
							<p>
                            	<a href="<c:url value='/admin'></c:url>">관리자 모드</a>
                        	</p>
                        	<p>
                            	<a href="<c:url value='/MyPage/InquiryList'></c:url>">문의 사항 조회</a>
                        	</p>
                        </c:if>
                    </li>
                </ul>
    ...
    <div class="container2">
        ...
        <ul>
        	<li>
            	...
            	<li>
                	<a href="<c:url value='/auction/list'></c:url>" onmouseover="mouseOver(this)" onmouseout="mouseOut(this)">실시간경매
                    	<sup>
                        	<font color="red">
                            	<b></b>
                        	</font>
            	...
            	<li><a><sup><font><b></b></font></sup></a></li>
            	<li><a><sup><font><b></b></font></sup></a></li>
            	<li><a><sup><font><b></b></font></sup></a></li>
            	<li><a><sup><font><b></b></font></sup></a></li>
            	<li><a><sup><font><b></b></font></sup></a></li>
            ...
            <c:if test="${user.me_authority == 1}">
            	<li>
                	<a href="<c:url value='/auction/insert'></c:url>" onmouseover="mouseOver(this)" onmouseout="mouseOut(this)">경매 등록
                    	<sup>
                        	<font color="">
                            	<b></b>
                        	</font>
            	...
            	<li>
                	<a href="<c:url value='/product/insert'></c:url>" onmouseover="mouseOver(this)" onmouseout="mouseOut(this)">물품등록</a>
            	</li>
            	 <li class="smallList1">
                	<select name="datafield" id="">
                    	<option value="">물품명</option>
