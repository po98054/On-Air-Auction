...
<div class="body">
  <h2>일반경매</h2>
  	<div class="col">
	  <c:forEach items="${productList }" var="auction">
	  	<div class="col-md-4">
  	...
  	<div class="pagination-container">
	  	...
	  	<c:if test="${pm.prev}">
	  		<li class="page-item">
	  			<a class="page-link" href="<c:url value='/general/list?page=${pm.startPage-1}&search=${pm.criteria.search}'></c:url>">이전</a>
	  		</li>
	  	</c:if>
	  	...
	  	<c:if test="${pm.next}">
	  		<li class="page-item">
	  			<a class="page-link" href="<c:url value='/general/list?page=${pm.endPage+1}&search=${pm.criteria.search}'></c:url>">다음</a>
	  		</li>
	  	</c:if>
	  	</ul>
  	</div>
