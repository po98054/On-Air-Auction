...
<div class="body">
        ...
        <div class="body-middle">
			...
			<div class="btn-list">
			<c:if test="${inquiry.in_me_id == user.me_id}">
			...
			<c:if test="${user.me_id.equals('admin') && inquiry.in_answer_date == null}">
				<a href="<c:url value='/MyPage/ReplyInquiryInsert/${inquiry.in_num}'></c:url>">
					<button class="btn btn-outline-primary btn-reply">답글 등록</button>
				</a>
			</c:if>
			<c:if test="${user.me_id.equals('admin') && inquiry.in_answer_date != null}">
				<a href="<c:url value='/MyPage/ReplyInquiryUpdate/${inquiry.in_num}'></c:url>">
					<button class="btn btn-outline-primary btn-replyUpdate">답글 수정</button>
				</a>
			</c:if>
            </div>
