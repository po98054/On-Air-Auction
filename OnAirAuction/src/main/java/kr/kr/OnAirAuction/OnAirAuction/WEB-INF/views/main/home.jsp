		...
		<div class="container-main">
			...
			<div class="container1-right">
				...
				<div class="container-artwork">
					<ul class="container-artwork-list">
						<li><a href="#">추천경매</a></li>
						<li><a href="#">인기경매</a></li>
						<li><a href="#">오늘마감</a></li>
						<li><a href="#">미술품</a></li>
						<li><a href="#">근현대생활사자료</a></li>
						<li><a href="#">도서</a></li>
						<li><a href="#">취미/수집</a></li>
						<li><a href="#">중고생활용품</a></li>
					</ul>
				</div>
			...
			<div class="container1-right mt30">
				...
				<div class="container-artwork">
					<ul class="container-artwork-list">
						...
						<li><a href="#">인기경매</a></li>
						<li><a href="#">오늘마감</a></li>
						<li><a href="#">예술조각품 &amp; 단순조각품</a></li>
						<li><a href="#">혼합매체 &amp; 콜라주</a></li>
						<li><a href="#">아트 사진</a></li>
						<li><a href="#">기타</a></li>
						<li><a href="#">아트 포스터</a></li>
					</ul>
				</div>
				<div class="container-artwork-slide">
					<div class="container-artwork-category l-area">
