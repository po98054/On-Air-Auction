...
<div class="body">
        ...
        <div class="body-middle">
            <h1 style="text-align: center; margin-top: 5px;">문의 사항 내역</h1>
        <div class="Result-Data">
            <table class="table table-hover">
                ...
                <c:forEach items="${list}" var="pa">
                    <tr>
                        <td>
                            <a href="<c:url value='/MyPage/InquiryDetail/${pa.in_num}'></c:url>" class="auction">${pa.in_num}</a>
                        </td>
                        <td>${pa.ic_name}</td>
                        <td>${pa.in_title}</td>
                        <td>${pa.in_me_id}</td>
            ...
            <ul class="pagination justify-content-center">
            	...
            	<c:if test = "${pm.prev}">
                    ...
                    <li class="page-item">
                    	...
                    	<a class="page-link" href="<c:url value='/MyPage/InquiryList?page=${pm.startPage - 1}'></c:url>">이전</a>
                ...
                <c:forEach begin="${pm.startPage}" end="${pm.endPage}" var="i">
                    ...
                    <li>
                    	...
                    	<a class="page-link" href="<c:url value='/MyPage/InquiryList?page=${i}'></c:url>">${i}</a>
                ...
                <c:if test="${pm.next}">
                    ...
                    <li class="page-item">
                    	...
                    	<a class="page-link" href="<c:url value='/MyPage/InquiryList?page=${pm.endPage + 1}'></c:url>">다음</a>
